...
export class ChatService {
  ...
  */
  ...
  /**
   * Método para formatear una respuesta generada por GPT.
   * Divide la respuesta en palabras individuales y filtra las palabras clave basándose en ciertos criterios, como longitud o relevancia.
   * @param gptResponse La respuesta generada por GPT.
   * @param title El título asociado a la respuesta.
   * @param imageURLs Arreglo de URLs de imágenes asociadas a la respuesta.
   * @returns Un objeto formateado que incluye el título, la descripción, las palabras clave y las URLs de las imágenes.
   */
  ...
  /**
   * Método para generar una respuesta de chat utilizando el servicio de OpenAI.
   * Busca el detalle de chat por su ID, genera una respuesta basada en su contenido utilizando el modelo GPT-4, y crea una imagen asociada utilizando el modelo DALL-E.
   * @param createGeneralChatDto DTO para crear un chat general.
   * @returns Un objeto formateado con la respuesta generada, incluyendo título, descripción, palabras clave y URLs de las imágenes.
   * @throws NotFoundException si no se encuentra el detalle de chat correspondiente al ID proporcionado.
   * @throws Error si no se puede obtener la URL de la imagen generada.
  */
  ...
  /**
   * Método asincrónico para generar un chat general a partir de un DTO proporcionado.
   * Utiliza el método generateChatResponse para obtener una respuesta de chat, y luego guarda los detalles del chat en la base de datos.
   * @param createGeneralChatDto DTO para crear un chat general.
   * @returns Los detalles del chat generados y guardados en la base de datos.
   * @throws NotFoundException si ocurre un error al generar la respuesta de chat.
  */
